...
class ProductsResource extends BaseResource
{
     ...
     * @param int $limite Mantido por compatibilidade; a API define o tamanho da página
     * @return array Resposta da API: `query`, `motor_busca`, `total_resultados` e `resultados`
     *               (cada item com `produto`, `score` e `justificativa`)
     */
