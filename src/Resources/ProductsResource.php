...
class ProductsResource extends BaseResource
{
    ...
    public function getEnriched(string|int $gtin): array
    {
        ...
        return $this->request('GET', "/api/v1/produtos/{$gtinLimpo}/completo");
    }
    ...
    {
        return $this->request('GET', '/api/v1/produtos/busca', [
            'q' => $query,
            'limite' => $limite,
        ]);
    }
    ...
    public function scan(string $caminhoOuBytes, ?string $nomeArquivo = null, ?string $tipo = null): array
    {
        ...
        return $this->request('POST', '/api/v1/produtos/imagem', files: $files, formData: $formData);
    }
}
