...
class ProductsTest extends TestCase
{
    ...
    public function testGetEnrichedProduct(): void
    {
        ...
        $mockHttp->expects($this->once())
            ...
            ->with(
                'GET',
                'https://api.pairus.com.br/api/v1/produtos/7891000100103/completo',
                $this->anything(),
                null,
                30.0
            )
    ...
    public function testSearchProducts(): void
    {
        ...
        $mockHttp->expects($this->once())
            ...
            ->with(
                'GET',
                'https://api.pairus.com.br/api/v1/produtos/busca?q=leite+condensado&limite=5',
                $this->anything(),
                null,
                30.0
            )
    ...
    public function testScanImageProduct(): void
    {
        ...
        $mockHttp->expects($this->once())
            ...
            ->with(
                'POST',
                'https://api.pairus.com.br/api/v1/produtos/imagem',
                $this->anything(),
